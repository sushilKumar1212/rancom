...
class _PickupPageState extends State<PickupPage> {
  ...
  Widget searchWidget() {
    return SizedBox(
      height: Get.height,
      width: Get.width,
      child: Consumer<PickupController>(
  ...
  Widget mapWidget() {
    return Consumer<PickupController>(builder: (context, controller, child) {
      return SizedBox(
        height: Get.height,
        width: Get.width,
...
addressfromplacemark(Placemark placemark) {
  return '${placemark.locality ?? ''}, ${placemark.subAdministrativeArea ?? ''}, ${placemark.administrativeArea ?? ''}, ${placemark.country ?? ''}, ${placemark.postalCode ?? ''}';
}
